            ...
            <Row className="justify-content-center">
                {products.map((product) => (
                    <Col key={product.id} lg={3} md={6} sm={6} xs={12} className="mb-4">
                        <Card className="homefeaturedproducts-card" onClick={() => handleShowPopup(product)}>
                            <Card.Img variant="top" src={product.image} className="homefeaturedproducts-img" />
                            <Card.Body>
                                <p className="homefeaturedproducts-category">{product.category} </p>
                                ...
                                <div className="homefeaturedproducts-actions">
                                    <div className="homefeaturedproducts-price">
                                        <span className="homefeaturedproducts-current">Rs. {product.price}/-</span>
                                        <span className="homefeaturedproducts-old">Rs. {product.oldPrice}/-</span>
                                    </div>
