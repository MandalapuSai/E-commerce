            ...
            <Container fluid className="px-5 py-3">
                <Card className="userprofile-card">
                    <div className="text-center d-flex align-items-center justify-content-start gap-3">
                        <img src={user.profileImage} alt="Profile" className="userprofile-avatar" />
                        <div className="text-start">
                            <h4 className="userprofile-name mb-1">{user.firstName} {user.lastName}</h4>
                        ...
                        {activeTab === "userinfo" ? (
                            <Form>
                                ...
                                <div className="userprofile-buttons">
                                    <Button variant="success" className="me-2 btn-save">Save</Button>
                                    <Button variant="danger" className="btn-cancel">Cancel</Button>
                                </div>
                            </Form>
                        ) : (
                            <Form >
