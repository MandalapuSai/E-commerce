...
import PaymentGate from "../../assets/payment-UPI.webp";
...
const PaymentGateway = () => {
  ...
  const validateForm = () => {
    ...
    if (!/^[0-9]{6}$/.test(formData.pinCode)) newErrors.pinCode = "PIN Code must be 6 digits";
          ...
          <Card className="p-4 paymentgateway-cards">
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control type="text" name="address" placeholder="Street address" onChange={handleChange} />
              ...
              <Row className="mb-3">
                <Col md={6}>
                  <Form.Group>
                    ...
                    <Form.Control type="text" name="city" placeholder="City" onChange={handleChange} />
                ...
                <Col md={3}>
                  <Form.Group>
                    ...
                    <Form.Control type="text" name="pinCode" placeholder="PIN Code" onChange={handleChange} />
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control type="text" name="phone" placeholder="Phone Number" onChange={handleChange} />
                {errors.phone && <span className="text-danger">{errors.phone}</span>}
              </Form.Group>

              <h4 className="mt-4">Payment Method</h4>
              <Form.Group className="mb-3">
                <Form.Label>All transactions are secure and encrypted.</Form.Label>
                <img src={PaymentGate} alt="UPI Payment" className="img-fluid mt-2 payment_gateway-ImgUPI" />
              </Form.Group>

              <Button type="submit" variant="primary" className="w-100 mt-3 payment_gateway-btn">
                Pay Now
              </Button>
            </Form>
          </Card>
