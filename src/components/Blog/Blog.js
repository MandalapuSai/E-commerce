            ...
            <div className="container py-4 mt-5">
                <div className="row container">
                    <div className="col-lg-8 mb-4 order-2 order-lg-1">
                        ...
                        <section>
                            <h6 className="mb-3" style={{ fontSize: '24px' }}>{selectedProduct.title}: The Perfect Blend of Taste and Convenience</h6>
                            <p style={{ textAlign: 'justify' }}>{selectedProduct.description}</p>
                            <h6 className='fw-bold mt-3 mb-4'>Why Choose Nuziveedu Forms’ {selectedProduct.title}?</h6>
                            ...
                            <h6 className='fw-bold mt-4 mb-4'>How to Use Coconut Powder in Cooking</h6>

                            <h6 className='fw-bold mt-4 mb-4'>Savory Delights</h6>
                            <ul style={{ display: 'flex', flexDirection: 'column', gap: '10px', paddingLeft: '20px' }}>
                                <li><strong>Curries:</strong> Add 2 tbsp Coriander powder to chicken and enrich curries and gravie.</li>
                            ...
                            <ul style={{ display: 'flex', flexDirection: 'column', gap: '10px', paddingLeft: '20px' }}>
                                <li><strong>Cakes and Muffins:</strong> Replace a portion of your flour with 2 tbsp coconut powder for a moist,
                                    flavorful texture</li>
                            ...
                            <h6 className='fw-bold mt-4 mb-4'>How to Use Coconut Powder in Skincare</h6>
                            ...
                            <ul style={{ display: 'flex', flexDirection: 'column', gap: '10px', paddingLeft: '20px' }}>
                                ...
                                <p>Massage onto your skin in circular motions, then rinse with lukewarm water.</p>
                            </ul>

                            <h6 className='fw-bold mt-4 mb-4'>Storing Coconut Powder the Right Way</h6>
                            <ul style={{ display: 'flex', flexDirection: 'column', gap: '10px', paddingLeft: '20px' }}>
                            ...
                            <h6 className='fw-bold mt-4 mb-4'>Coconut Powder: A Kitchen and Beauty Must-Have</h6>

                            <p>Whether you're whipping up a quick meal, crafting desserts, or pampering your skin, coconut powder is an
                                indispensable ingredient. Its convenience and versatility make it a favorite for home cooks and DIY beauty
                                enthusiasts alike.</p>


                            <p>Bring home the tropical goodness with Annapurna Farms’ Coconut Powder, available in sizes to suit all
                                your needs. It’s natural, pure, and ready to elevate your cooking and wellness routine.</p>
                                ...
                                {productData.map((product, index) => (
                                    <li
                                        ...
                                        style={{
                                            cursor: 'pointer',
                                            paddingLeft: '0px',
                                            color: product.title === selectedProduct.title ? 'red' : 'black',
                                            fontWeight: product.title === selectedProduct.title ? 'bold' : 'normal'
                                        }}
                ...
                <div className='row'>
                        ...
                        CardsData.map((item, index) => (
                            <div className='col-md-4' key={index}>
                                <img
                                    ...
                                    alt="..."
                                    style={{ backgroundColor: '#7be2e5', borderRadius: '8px' }}
                                />
                                <div className='text-center' style={{ marginTop: '-10px' }}>
                                    <span className="cardtxt mb-3">{item.title}</span>
                                    <h5 className='mt-2'><b>{item.name}</b></h5>
                                </div>
                            </div>
                        ))
                    }
                    ...
                    {/* <div className='col-md-4'>
                        <img src={first} class="card-img-top" alt="..." style={{ backgroundColor: '#7be2e5', borderRadius: '8px' }} />
                        <div className='text-center' style={{ marginTop: '-10px' }}>
                            <span class="cardtxt mb-3">Card title</span>
                            <h5 className='mt-2'><b>Benefits of Coconut Powder</b></h5>
                        </div>
                    </div>
